  ...
  return (
    <main className='grid pb-8 pt-20'>
      ...
      <section className='px-8 pb-10 justify-self-center max-w-[1200px]'>
        <div className='bg-(--primario-700) text-(--terciario-50) rounded-xl grid px-8 py-6 gap-5'>
      ...
      <section className='px-8 pb-6 justify-self-center max-w-[1200px] lg:pb-10'>
        <div className='grid'>
        <h2 className='titulo-section text-(--primario-700) pb-5 md:pb-7'>Invista no Cardápio Digital em QR-Code hoje mesmo se você quer</h2>

        <ul className=' grid gap-3'>
          <li className='bg-(--secundario-200) text-(--secundario-900) grid gap-1.5  py-4 px-5 rounded-xl sm:py-5 sm:px-4'>
            ...
            <li className='bg-(--primario-700) text-(--primario-100) grid gap-1.5  py-4 px-5 rounded-xl sm:py-5 sm:px-4'>
