            ...
            <div className='grid gap-7 md:grid-cols-2 md:pb-10'>
              <div className='bg-(--terciario-50) px-4 py-3 rounded-lg grid gap-2'>
                ...
                <div className='flex gap-2.5 hover:gap-5 hover:transition duration-300 ease-initial max-w-max'>
                  <NavLink to='/login' className='font-sans font-medium text-(--secundario-800) transition duration-700 ease-in-out sm:text-xl' >Ver Mais</NavLink>
              ...
              <div className='bg-(--terciario-50) px-4 py-3 rounded-lg grid gap-2'>
                ...
                <div className='flex gap-2.5 hover:gap-5 hover:transition duration-300 ease-initial max-w-max'>
                  <span className='font-sans font-medium text-(--secundario-800) transition duration-700 ease-in-out sm:text-xl'>Ver Mais</span>
                  <img src={seta} alt="seta" />
                </div>
              </div>
            </div>
